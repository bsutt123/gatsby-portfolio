  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.stories}> 
        <Story heading="Harvey Mudd College" image="/images/hmc.jpg">
        ...
        <Story heading="SpaceX" image="/images/spacex.jpg">
        ...
        <Story heading="Eagle's Next Camp" image="/images/enf-1.jpg">
        ...
        <Story heading="Chipotle" image="/images/chipotle.png">
